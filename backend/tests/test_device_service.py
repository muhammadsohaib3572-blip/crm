...
@pytest.mark.asyncio
async def test_valid_device_transition_under_development_to_qa():
    await DeviceService._validate_status_transition(
...
@pytest.mark.asyncio
async def test_invalid_device_transition_installed_to_under_development():
...
@pytest.mark.asyncio
async def test_installed_requires_client_id():
